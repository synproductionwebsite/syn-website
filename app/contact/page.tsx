    ...
    <div className="max-w-3xl mx-auto p-8 text-center text-gray-900">
      ...
      <div className="flex flex-col items-center md:flex-row md:items-center md:justify-center gap-8">
        <img
          ...
          alt="SYN logo"
          className="cursor-pointer w-50 h-auto transition-transform duration-300 hover:scale-110"
          onClick={() => {
        ...
        <div className="space-y-2 text-left md:text-left">
          ...
          <p className="text-lg">
            ...
            <a href="tel:+33646139243" className="text-[#734A93] hover:underline">
              06 46 13 92 43
            </a>
          </p>
        ...
        <a href="https://www.instagram.com/synproduction?igsh=MTkyNzdwZjRvZnh6NQ%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="transition-transform transform hover:scale-150">
          <Image src="/img/icon/instagram_purple.png" alt="Instagram Icon" width={30} height={30} className="rounded-md transition-opacity duration-300" />
        ...
        <a href="https://www.tiktok.com/@syn.production?_t=ZN-8xhQ0wpdRCA&_r=1" target="_blank" rel="noopener noreferrer" className="transition-transform transform hover:scale-150">
          <Image src="/img/icon/tiktok_purple.png" alt="TikTok Icon" width={30} height={30} className="rounded-md transition-opacity duration-300" />
        ...
        <a href="https://www.linkedin.com/company/syn-production/" target="_blank" rel="noopener noreferrer" className="transition-transform transform hover:scale-150">
          <Image src="/img/icon/linkedin_purple.png" alt="LinkedIn Icon" width={30} height={30} className="rounded-md transition-opacity duration-300" />
        ...
        <a href="https://www.facebook.com/profile.php?id=61566561786488" target="_blank" rel="noopener noreferrer" className="transition-transform transform hover:scale-150">
          <Image src="/img/icon/facebook_purple.png" alt="Facebook Icon" width={30} height={30} className="rounded-md transition-opacity duration-300" />
